...
class Styles {
  ...
  static TextStyle headLineStyle22 = TextStyle(fontSize: 20,color: textColor,fontWeight:FontWeight.w500);
  static TextStyle headLineStyle33 = TextStyle(fontSize: 22,color: textColor,fontWeight:FontWeight.w500);
